...
const envSchema = z.object({
  ...
  SYNC_MAX_BATCHES_PER_INVOCATION: positiveInt(3),
  SYNC_MAX_CHAIN_DEPTH: positiveInt(8),
...
export const env = envSchema.parse({
  ...
  SYNC_MAX_BATCHES_PER_INVOCATION: process.env.SYNC_MAX_BATCHES_PER_INVOCATION,
  SYNC_MAX_CHAIN_DEPTH: process.env.SYNC_MAX_CHAIN_DEPTH,
